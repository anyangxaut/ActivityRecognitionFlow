...
CREATE DATABASE IF NOT EXISTS `activityrecognition` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE IF NOT EXISTS `featureextraction` (
  ...
  `RKN_accX_RKN_accX_correlation` text NOT NULL COMMENT '单位：mg',
  ...
  `RKN_accY_RKN_accY_correlation` text NOT NULL COMMENT '单位：mg',
  ...
  `RKN_accZ_RKN_accZ_correlation` text NOT NULL COMMENT '单位：mg',
  ...
  `HIP_accX_HIP_accX_correlation` text NOT NULL COMMENT '单位：mg',
  ...
  `HIP_accY_HIP_accY_correlation` text NOT NULL COMMENT '单位：mg',
  ...
  `HIP_accZ_HIP_accZ_correlation` text NOT NULL COMMENT '单位：mg',
  ...
  `LUA_accX_LUA_accX_correlation` text NOT NULL COMMENT '单位：mg',
  ...
  `LUA_accY_LUA_accY_correlation` text NOT NULL COMMENT '单位：mg',
  ...
  `LUA_accZ_LUA_accZ_correlation` text NOT NULL COMMENT '单位：mg',
