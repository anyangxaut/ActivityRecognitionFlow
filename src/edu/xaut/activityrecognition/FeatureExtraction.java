...
public class FeatureExtraction {
	...
	public void splitAction(int Locomotion, String tableName){
		...
		for(int i = 0; i < list.size(); i++){
			...
			sqlAdd[index] = "insert into " + tableName + " (Time, RKN_accX, RKN_accY, RKN_accZ, HIP_accX, HIP_accY, HIP_accZ, " +
						"LUA_accX, LUA_accY, LUA_accZ, Locomotion) values ('" + data.get(0) + "', '" + data.get(1) + "', '" + 
	...
	public void startFeatureExtraction(int Locomotion, String tableName){
		...
		for(int i = 0; i < sumData; i = i + overlapSzie){
			...
			sqlAdd[0] = "INSERT INTO `featureextraction` (`RKN_accX_mean`, `RKN_accY_mean`, `RKN_accZ_mean`, `HIP_accX_mean`, `HIP_accY_mean`, " +
					...
					"`LUA_accZ_variance`, `RKN_accX_RKN_accX_correlation`, `RKN_accX_RKN_accY_correlation`, `RKN_accX_RKN_accZ_correlation`," +
					...
					"`RKN_accY_RKN_accX_correlation`, `RKN_accY_RKN_accY_correlation`, `RKN_accY_RKN_accZ_correlation`, " +
					...
					"`RKN_accZ_RKN_accX_correlation`, `RKN_accZ_RKN_accY_correlation`, `RKN_accZ_RKN_accZ_correlation`, " +
					...
					"`HIP_accX_HIP_accX_correlation`, `HIP_accX_HIP_accY_correlation`, `HIP_accX_HIP_accZ_correlation`, " +
					...
					"`HIP_accY_HIP_accX_correlation`, `HIP_accY_HIP_accY_correlation`, `HIP_accY_HIP_accZ_correlation`, " +
					...
					"`HIP_accZ_HIP_accX_correlation`, `HIP_accZ_HIP_accY_correlation`, `HIP_accZ_HIP_accZ_correlation`, " +
					...
					"`LUA_accX_LUA_accX_correlation`, `LUA_accX_LUA_accY_correlation`, `LUA_accX_LUA_accZ_correlation`, " +
					...
					"`LUA_accY_LUA_accX_correlation`, `LUA_accY_LUA_accY_correlation`, `LUA_accY_LUA_accZ_correlation`, " +
					...
					"`LUA_accZ_LUA_accX_correlation`, `LUA_accZ_LUA_accY_correlation`, `LUA_accZ_LUA_accZ_correlation`, " +
					...
					"('" + meanValue[0]+ "', '" + meanValue[1] + "', '" + meanValue[2] + "', '" + meanValue[3] + "', '" + meanValue[4] + "', '" + meanValue[5] + "', '" + meanValue[6] + "', '" + meanValue[7] + "', '" + meanValue[8] + "', '" + varianceValue[0] + "', '" + varianceValue[1] + "', '" + varianceValue[2] + "', '" + varianceValue[3] + "', '" + varianceValue[4] + "', '" + varianceValue[5] + "', '" + varianceValue[6] + "', '" + varianceValue[7] + "', '" + varianceValue[8] + "', '" + correlationValue[0] + "'," +
							" '" + correlationValue[1] + "', '" + correlationValue[2] + "', '" + correlationValue[3] + "', '" + correlationValue[4] + "', '" + correlationValue[5] + "', '" + correlationValue[6] + "', '" + correlationValue[7] + "', '" + correlationValue[8] + "', '" + correlationValue[9] + "', '" + correlationValue[10] + "', '" + correlationValue[11] + "', '" + correlationValue[12] + "', '" + correlationValue[13] + "', '" + correlationValue[14] + "', '" + correlationValue[15] + "', '" + correlationValue[16] + "', '" + correlationValue[17] + "', '" + correlationValue[18] + "', '" + correlationValue[19] + "', '" + correlationValue[20] + "', '" + correlationValue[21] + "', " +
									"'" + correlationValue[22] + "', '" + correlationValue[23] + "', '" + correlationValue[24] + "', '" + correlationValue[25] + "', '" + correlationValue[26] + "', '" + correlationValue[27] + "', '" + correlationValue[28] + "', '" + correlationValue[29] + "', '" + correlationValue[30] + "', '" + correlationValue[31] + "', '" + correlationValue[32] + "', '" + correlationValue[33] + "', '" + correlationValue[34] + "', '" + correlationValue[35] + "', '" + correlationValue[36] + "', '" + correlationValue[37] + "', '" + correlationValue[38] + "', '" + correlationValue[39] + "', '" + correlationValue[40] + "', '" + correlationValue[41] + "', '" + correlationValue[42] + "'," +
											" '" + correlationValue[43] + "', '" + correlationValue[44] + "', '" + correlationValue[45] + "', '" + correlationValue[46] + "', '" + correlationValue[47] + "', '" + correlationValue[48] + "', '" + correlationValue[49] + "', '" + correlationValue[50] +"', '" + correlationValue[51] + "', '" + correlationValue[52] + "', '" + correlationValue[53] + "', '" + correlationValue[54] + "', '" + correlationValue[55] + "', '" + correlationValue[56] + "', '" + correlationValue[57] + "', '" + correlationValue[58] + "', '" + correlationValue[59] + "', '" + correlationValue[60] + "', '" + correlationValue[61] + "', '" + correlationValue[62] + "', '" + correlationValue[63] + "'," +
													" '" + correlationValue[64] + "', '" + correlationValue[65] + "', '" + correlationValue[66] + "', '" + correlationValue[67] + "', '" + correlationValue[68] + "', '" + correlationValue[69] + "', '" + correlationValue[70] + "', '" + correlationValue[71] + "', '" + correlationValue[72] + "', '" + correlationValue[73] + "', '" + correlationValue[74] + "', '" + correlationValue[75] + "', '" + correlationValue[76] + "', '" + correlationValue[77] + "', '" + correlationValue[78] + "', '" + correlationValue[79] + "', '" + correlationValue[80] + "', '" + energyValue[0] + "', '" + energyValue[1] + "', '" + energyValue[2] + "', '" + energyValue[3] + "'," +
															" '" + energyValue[4] + "', '" + energyValue[5] + "', '" + energyValue[6] + "', '" + energyValue[7] + "', '" + energyValue[8] + "', '" + Locomotion + "');";
			// 执行插入语句
			dao.save(sqlAdd);
		}
	...
	public double[] means(List<DataEntity> list){
		...
		for(int i = 0; i < list.size(); i++){
			List<String> data = list.get(i).getDataInfo();
			// 计算各轴加速度数据之和
			sum_RKN_accX = sum_RKN_accX + Double.parseDouble(data.get(1));
			sum_RKN_accY = sum_RKN_accY + Double.parseDouble(data.get(2));
			sum_RKN_accZ = sum_RKN_accZ + Double.parseDouble(data.get(3));
			sum_HIP_accX = sum_HIP_accX + Double.parseDouble(data.get(4));
			sum_HIP_accY = sum_HIP_accY + Double.parseDouble(data.get(5));
			sum_HIP_accZ = sum_HIP_accZ + Double.parseDouble(data.get(6));
			sum_LUA_accX = sum_LUA_accX + Double.parseDouble(data.get(7));
			sum_LUA_accY = sum_LUA_accY + Double.parseDouble(data.get(8));
			sum_LUA_accZ = sum_LUA_accZ + Double.parseDouble(data.get(9));
		}
	...
	public double[] variance(List<DataEntity> list, double[] meanValue){
		...
		for(int i = 0; i < list.size(); i++){
			...
			tmp = Double.parseDouble(data.get(4))- meanValue[3];
			square_HIP_accX = square_HIP_accX + Math.pow(tmp, 2);
			tmp = Double.parseDouble(data.get(5))- meanValue[4];
			square_HIP_accY = square_HIP_accY + Math.pow(tmp, 2);
			tmp = Double.parseDouble(data.get(6))- meanValue[5];
			square_HIP_accZ = square_HIP_accZ + Math.pow(tmp, 2);
			tmp = Double.parseDouble(data.get(7))- meanValue[6];
			square_LUA_accX = square_LUA_accX + Math.pow(tmp, 2);
			tmp = Double.parseDouble(data.get(8))- meanValue[7];
			square_LUA_accY = square_LUA_accY + Math.pow(tmp, 2);
			tmp = Double.parseDouble(data.get(9))- meanValue[8];
	...
	public double[] energy(List<DataEntity> list){
		...
		for(int i = 0; i < list.size(); i++){
			List<String> data = list.get(i).getDataInfo();
				// 数据实部
				real_RKN_accX[index] = Double.parseDouble(data.get(1));
				real_RKN_accY[index] = Double.parseDouble(data.get(2));
				real_RKN_accZ[index] = Double.parseDouble(data.get(3));
				real_HIP_accX[index] = Double.parseDouble(data.get(4));
				real_HIP_accY[index] = Double.parseDouble(data.get(5));
				real_HIP_accZ[index] = Double.parseDouble(data.get(6));
				real_LUA_accX[index] = Double.parseDouble(data.get(7));
				real_LUA_accY[index] = Double.parseDouble(data.get(8));
				real_LUA_accZ[index] = Double.parseDouble(data.get(9));
				// 数据虚部
