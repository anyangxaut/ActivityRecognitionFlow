...
public class NaiveBayesianAlgorithm {
	...
	public void trainNBC(int WeightType) {
		...
		// 查询相关数据
		String sqlStand = "select * from fusionresult where WeightType = " + WeightType + " and locomotion = 1;";
		...
		// 查询相关数据
		String sqlWalk = "select * from fusionresult where WeightType = " + WeightType + " and locomotion = 2;";
		...
		// 查询相关数据
		String sqlSit = "select * from fusionresult where WeightType = " + WeightType + " and locomotion = 4;";
		...
		// 查询相关数据
		String sqlLie = "select * from fusionresult where WeightType = " + WeightType + " and locomotion = 5;";
